...
$paymentmethode = filterRequest("paymentmethode");
...
$carusers = filterRequest("carusers");
...
$data = array(
    ...
    "orders_cityup"  => $cityup,
     "orders_citydown"  => $citydown,
     "orders_tyapetrack"  => $tyapetrack,
     "orders_carusers"  => $carusers,
     "orders_phone"  => $phone,
    "orders_paymentmethode"  =>  $paymentmethode
);
